			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<sf:form action="${contextRoot}/manage/products" method="POST"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="number" path="unitPrice" id="unitPrice"
									placeholder="Unit Price In &#8377;" class="form-control"></sf:input>
						...
						<div class="form-group">
							<label class="control-lable col-md-4" for="category">Select
								Category:</label>
							<div class="col-md-8">
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<sf:textarea cols="" rows="5" path="description"
										id="category_description" type="text" class="form-control" />
								</div>
							</div>
