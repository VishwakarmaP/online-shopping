...
<div class="container">
	...
	<div class="col-xs-12">
	 ...
	 ${message}
		...
		<div class="col-md-offset-2 col-mc-8">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<sf:form action="${contextRoot}/manage/products" method="POST" class="form-horizontal" modelAttribute="product">
						...
						<div class="form-group">
							<label class="control-lable col-md-4" for="brand">Enter Product Brand:</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="number" path="unitPrice" id="unitPrice" placeholder="Unit Price In &#8377;" class="form-control"></sf:input>
